...
def calculate_psnr_ssim(clear_img_path, enhanced_img_path, clear_img_names):
    ...
    for i in range(len(clear_img_names)):
        ...
        enhanced_img = io.imread(os.path.join(enhanced_img_path, f'{clear_img_names[i].split(".")[0]}.png'))
...
# 测试函数
clear_img_path = '/home/suxin/mambaeec/data/test/gt/'  # 清晰图像文件夹路径/home/suxin/RUAS/result2/0082.png
enhanced_img_path = '/home/suxin/RUAS/result/'  # 增强后的图像文件夹路径
